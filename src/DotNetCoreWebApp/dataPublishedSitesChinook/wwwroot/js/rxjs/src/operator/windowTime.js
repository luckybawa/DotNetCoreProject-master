System.register(["../Subject", "../scheduler/async", "../Subscriber"], function (exports_1, context_1) {
    "use strict";
    ...
    var Subject_1, async_1, Subscriber_1, WindowTimeOperator, WindowTimeSubscriber;
    return {
        setters: [
